#!/bin/bash
# Multi-Robot Fleet Test Script - 3 Robots (N-Machine Mode)
# Usage: bash test_multi_robot.sh
#
...
#
# Robot positions are configured for三方交汇场景 (triple-meet scenario)
# where all 3 robots approach the center point (0, 0) simultaneously.
...
echo "=========================================="
echo ""
echo "Scenario: 三方交汇 (Triple-Meet)"
echo "  robot_a: (-4, 0) → east"
echo "  robot_b: ( 4, 0) → west"
echo "  robot_c: ( 0, 4) → south"
echo ""
...
echo "   Spawning robot_a at (-4, 0) facing east..."
...
echo "   Spawning robot_b at (4, 0) facing west..."
ros2 run gazebo_ros spawn_entity.py \
    -entity robot_b \
...
echo "   Spawning robot_c at (0, 4) facing south..."
ros2 run gazebo_ros spawn_entity.py \
    -entity robot_c \
...
echo "   Note: Each coordinator is started with peer_ids=[other robots]"
echo ""
...
echo ""
echo "=========================================="
echo "  Setup Complete - All 3 Robots Running"
echo "=========================================="
echo ""
echo "To view coordinator logs:"
echo "  screen -r coord_a  (robot_a)"
echo "  screen -r coord_b  (robot_b)"
echo "  screen -r coord_c  (robot_c)"
echo "  screen -r mock_path  (mock path publisher)"
echo ""
echo "To detach from a screen: Ctrl+A D"
echo ""
echo "Expected behavior:"
echo "  - All 3 robots should discover each other"
echo "  - Priority order (robot_id lexicographic): robot_a > robot_b > robot_c"
echo "  - robot_a (highest) should PASS through at 30%"
echo "  - robot_b and robot_c should YIELD at 0%"
echo ""
echo "To monitor coordination status:"
echo "  ros2 topic echo /robot_a/fleet/coordinator_speed"
echo "  ros2 topic echo /robot_b/fleet/coordinator_speed"
echo "  ros2 topic echo /robot_c/fleet/coordinator_speed"
echo ""
